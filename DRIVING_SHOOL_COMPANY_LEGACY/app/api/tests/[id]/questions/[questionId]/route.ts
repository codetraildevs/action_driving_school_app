// app/api/tests/[id]/questions/[questionId]/route.ts
...
const removeQuestionFromTestHandler = withPermission(PERMISSIONS.TEST_UPDATE)(
  async (
    request: NextRequest,
...
export const DELETE = removeQuestionFromTestHandler;